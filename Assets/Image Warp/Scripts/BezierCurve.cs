...
namespace Fenderrio.ImageWarp
{
	...
	public class BezierCurve
	{
		...
		public Vector3 GetCurvePointHandleA(int a_pointIndex)
		{
			if(m_pointsData.Length <= a_pointIndex)
				return Vector3.zero;

			return m_pointsData [a_pointIndex].HandlePointA;
		}

		public Vector3 GetCurvePointHandleB(int a_pointIndex)
		{
			if(m_pointsData.Length <= a_pointIndex)
				return Vector3.zero;

			return m_pointsData [a_pointIndex].HandlePointB;
		}
